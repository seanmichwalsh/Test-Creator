...
{
    public static int chap, mc, open, obj;
    ...
    {	
        ...
        //Creates the word documents
         chap = chapterNumber.getSelectedIndex() + 8;
         mc = Integer.parseInt(numberOfMCQField.getText());
         obj = Integer.parseInt(numberOfObjectiveQField.getText());
         open = Integer.parseInt(numberOfOpenEndedQField.getText());
         
         DocWriter docs = new DocWriter(chap, mc, open, obj);
         JOptionPane.showMessageDialog(null, "Your test was successfully generated!");
